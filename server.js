...
const passportjs=require('../url-shortener-master/config/passport')
const LocalStrategy = require('passport-local').Strategy;
const bcrypt = require('bcrypt');
const app=express()
const User=require('../url-shortener-master/models/user')
const ShortUrl=require('../url-shortener-master/models/shortUrl')
